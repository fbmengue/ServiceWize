...
<option value=""></option>
    ...
    <option value="<?php echo $itemMyService['serviceID'] . "|" . $itemMyService['time'] . "|" . $itemMyService['servicePrice'] ?>"><?php echo $itemMyService['serviceName'] ?></option>
...
<div class="col-md-6">
    ...
    foreach ($myServiceList as $itemMyService) {
        ...
        <option value="<?php echo $itemMyService['serviceID'] . "|" . $itemMyService['time'] . "|" . $itemMyService['servicePrice']  ?>"><?php echo $itemMyService['time'] ?></option>
...
<div class="col-md-6">
    ...
    foreach ($myServiceList as $itemMyService) {
        ...
        <option value="<?php echo $itemMyService['serviceID'] . "|" . $itemMyService['time'] . "|" . $itemMyService['servicePrice']  ?>"><?php echo $itemMyService['servicePrice'] ?></option>
