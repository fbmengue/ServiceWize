...
<select id="selectClientName" name="selectClientName" required placeholder="" class="form_data_professional">
    <option value=""></option>
    <?php
...
<div class="col-md-12">
    ...
    <select id="selectClientEmail" name="selectClientEmail" required placeholder="" class="form_data_professional">
        <option value=""></option>
        <?php
        foreach ($clientList as $itemClient) {
            ?>
...
<div class="col-md-6">
    ...
    <select id="selectClientBirthDate" name="selectClientBirthDate" placeholder="" class="form_data_professional">
        <option value=""></option>
        <?php
        foreach ($clientList as $itemClient) {
            ?>
...
<div class="col-md-6">
    ...
    <select id="selectClientMobile" name="selectClientMobile" placeholder="" class="form_data_professional">
        <option value=""></option>
        <?php
        foreach ($clientList as $itemClient) {
            ?>
