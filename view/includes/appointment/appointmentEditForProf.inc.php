...
if (isset($_POST["appointmentID"])) {
    ...
    $serviceArrayID = explode('|', $_POST['selectServiceNameForProfessionalEdit']);
    ...
    $professionalID = $newProfessionalData->getMyProfessionalIDByEmail($professionalEmail);
    ...
    $newAppointment->editMyProfessionalAppointmentByID($appointmentID, $clientID, $professionalID, $serviceID, $appointmentDate, $appointmentStartTime, $appointmentEndTime, $serviceDuration, $servicePrice);
