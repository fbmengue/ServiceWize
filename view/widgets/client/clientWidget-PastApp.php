...
$hoje = date('Y-m-d', time());
  ...
  // include __DIR__ . '/../../../controller/client-contr.classes.php';
    ...
    // Roda erros
     $myClientAppointmentList = $myAppointmentList->getMyClientPastAppointmentByEmail($_SESSION["userEmail"], $hoje);
            ...
            <?php foreach ($myClientAppointmentList as $item) {
                ...
                <div class="appointment-dayview col-sm-12 bg-widget mt-3 p-3 rounded-3 /*bg-box-shadow-thin*/">
                    ...
                    <div class="appointment-content-past row">
                        ...
                        <div class="appointment-dayview-service-past col-sm-12">
