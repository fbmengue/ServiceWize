...
// New appointment list by date
 $myAppointmentCount = new ClientContr();


// Roda erros
$myClientAppointmentCount = $myAppointmentCount->getMyClientAppointmentCount($_SESSION["userEmail"]);


?>

<div class="w-100 d-flex p-3 justify-content-between align-items-center clients-preview">

<div class="w-100 d-flex justify-content-between align-items-center clients-Preview appointments-preview">
    ...
    <div class="appointments-text">My Appointments</div>
    <div class="appointments-number"><?php echo $myClientAppointmentCount[0][0]; ?></div>
</div>
