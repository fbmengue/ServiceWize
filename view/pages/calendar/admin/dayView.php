...
<section class="d-flex flex-column align-items-center pt-0 pb-8 bg-default main-content">
    ...
    <div id="dayViewHeader" class="d-flex flex-column w-100 align-items-center bg-white /*bg-box-shadow-calendar*/"
        ...
        <?php
            include __DIR__ . '/../../../widgets/admin/adminCalendar-DayView.php';
        ?>
    </div>
                ...
                <div class="appointment-dayview col-sm-12 bg-widget mt-3 p-3 rounded-3 /*bg-box-shadow-thin*/">
                    <div class="row">
                        ...
                        <div class="appointment-dayview-client d-flex justify-content-between col-sm-12">
                            ...
                            <div>Professional: <?php echo $dayItem['professionalFullName']; ?></div>
                        </div>
                    </div>
            ...
            <form class="row g-3" id="form-cancel-appointment" method="POST">
                ...
                <div class="col-12">
                    <button id="appointmentButtonForClientCancel"
                        onclick="cancelAppointmentForAdmin(this); return false;" class="btn btn-primary">Yes
                    </button>
