<section class="d-flex flex-column align-items-center pt-4 pb-8 bg-default">
    ...
    <div class="d-flex flex-column w-100 align-items-center p-5 px-6 bg-white rounded-2" style="max-width: 490px">
        ...
        <div class="w-100 mt-4 mb-3">
            <form method="post" action="#" enctype="application/x-www-form-urlencoded">
                <button
                    ...
                    <p class="fw-semibold hover-transition w-100 m-0">Registre-se
                        com o Facebook</p>
                </button>
            </form>
            ...
            <form method="post" action="#" enctype="application/x-www-form-urlencoded">
                <button
                    class="button-google hover-transition w-100 d-flex align-items-center justify-content-center px-4 bg-white border rounded-2 h-50px">
        ...
        <form method="post" action="view/includes/cadastro.inc.php" id="singIn"
            class="w-100 d-flex flex-column align-items-center">
            <div class="w-100 d-flex flex-column mb-3">
                <label class="mb-2 fw-semibold" for="nome">Seu nome</label>
                <input required class="border h-12 px-3 rounded-1 w-100 input-outline" type="firstName" name="firstName" id="firstName">
            </div>
            <div class="w-100 d-flex flex-column mb-3">
                <label class="mb-2 fw-semibold" for="nome">Sobrenome / Apelido</label>
                <input required class="border h-12 px-3 rounded-1 w-100 input-outline" type="lastName" name="lastName" id="lastName">
            </div>
            <div class="w-100 d-flex flex-column mb-3">
            ...
            <div class="w-100 d-flex flex-row mb-3">
                <div class="d-flex flex-column w-50">
                    <label class="mb-2 fw-semibold" for="password">Sua
                        senha</label>
                    <input required class="border h-12 px-3 rounded-1 w-100 input-outline"
                        type="password" name="password" id="password">
                </div>

                <div class="d-flex flex-column w-50 ms-2">
                    <label class="mb-2 fw-semibold" for="password">Repetir
                        senha</label>
                    <input required class="border h-12 px-3 rounded-1 w-100 input-outline"
            ...
            <div class="mt-2 w-100 d-flex justify-content-center align-items-center">
                ...
                class="w-18px h-18px border rounded-4">
                <label class="ms-3 text-secondary leading-none" for="termsOfuse">Li e concordo com os 
                    <a class="text-1DB968 fw-semibold" href="/termos-de-uso">termos de uso</a>
                </label>
            </div>
            <button type="submit"
                class="w-100 h-50px text-white font-semibold mt-7 rounded-2 border-0 bg-green-medium">Cadastrar</button>
        </form>
    </div>
    <footer class="mt-7 mb-4">
        <p class="m-0 text-secondary text-sm">Já sou cadastrado.
            <a class="text-1DB968 fw-semibold" href="?page=login">Quero fazer login!</a>
        </p>
    </footer>
</section>
